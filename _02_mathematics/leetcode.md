# LeetCode Equivalent Problems (Mathematics)
...
*Note: Many basic number-theory exercises (palindrome/prime/GCD-LCM variants, digit manipulation, series formulas) are fundamental building blocks and may not have a direct 1:1 equivalent on LeetCode as standalone problems, but they underpin the math-heavy problems listed above.*
