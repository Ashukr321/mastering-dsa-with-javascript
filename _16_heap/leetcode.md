# LeetCode Equivalent Problems (Heap)
...
*Note: Heaps (priority queues) are the go-to structure whenever you need repeated access to the min/max element - top-k problems, k-way merges, greedy scheduling, and running-median queries all reduce to "maintain a heap and pop/push in O(log n)", making this one of the highest-leverage patterns to master for interviews.*
