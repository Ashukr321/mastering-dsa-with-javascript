# LeetCode Equivalent Problems (Matrix)
...
### **📊 Total LeetCode Questions: 16**

*Note: Matrix problems test a mix of in-place manipulation (rotation, zeroing, transposition), grid traversal via DFS/BFS (islands, flood fill, word search), and 2D dynamic programming (unique paths, maximal square) - all frequently combined in interview follow-ups. Rows prefixed with "P" are additional similar/equivalent practice problems (not tied to a specific file in this folder) added for broader interview coverage.*
