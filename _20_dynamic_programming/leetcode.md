# LeetCode Equivalent Problems (Dynamic Programming)
...
### **📊 Total LeetCode Questions: 20**

*Note: Dynamic Programming problems are grouped by recurring shapes - 1D sequence DP, 2D grid/string DP, 0/1 knapsack, and interval DP - recognizing which shape a problem fits is the key interview skill. Rows prefixed with "P" are additional similar/equivalent practice problems (not tied to a specific file in this folder) added for broader interview coverage across Easy, Medium, and Hard difficulty.*
